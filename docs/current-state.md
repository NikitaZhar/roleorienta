...
**Обновлено:** 2026-09-25, после §86.
**Срезов с последнего аудита: 10** — следующий срез аудит (регламент §5) (последний аудит — §76).
...
- Бренд доски ≠ тенант — поиск на площадке по бренду (§86). Следующий срез — аудит §76–§86.
