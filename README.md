...
> идемпотентность), обнаружение работодателей (гейт уверенности, гарвест), сбор и
> нормализация (адаптер Greenhouse), извлечение требований, подписки, уведомления,
> отклики/заметки/собеседования, отчёты об ошибках. В работе (ядро ценности):
> автоматический вход обнаружения по вендорным шаблонам, покрытие
